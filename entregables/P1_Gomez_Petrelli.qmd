...
1.  **Caracterizar** la distribución espacial y temporal de la tasa de incidencia de intentos de suicidio (Evento 356) en Colombia, mediante medidas descriptivas, patrones de variación y comportamientos diferenciales por departamento.
2.  **Comparar** las tendencias de la tasa de incidencia entre departamentos y periodos de análisis, con el fin de identificar territorios con comportamientos crecientes, decrecientes o estables.
3.  **Analizar** la relación entre la tasa de incidencia de intentos de suicidio y variables sociodemográficas y determinantes socioeconómicos, para reconocer factores asociados al riesgo territorial.
4.  **Identificar** y localizar clústeres territoriales y departamentos con mayores niveles de incidencia, priorizando aquellos con concentraciones persistentes o simultáneamente asociadas a condiciones de vulnerabilidad.
5.  **Desarrollar** un tablero de control interactivo que integre indicadores, visualizaciones y herramientas de exploración geográfica para comunicar hallazgos y apoyar la toma de decisiones en salud pública territorial.
